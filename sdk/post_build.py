...
def create_xcframework(sdk_zip_file, sdk_unzip_dir, sdk_install_config, platform):
    ...
    zip_dir(sdk_zip_file, sdk_unzip_dir, compression=zipfile.ZIP_DEFLATED)
...
def main():
    ...
    if args.platform == 'android' and not os.path.exists(sdk_unzip_dir):
        return
    if args.platform == 'ios' and os.path.exists(sdk_unzip_dir):
        try:
    ...
    create_xcframework(sdk_zip_file, sdk_unzip_dir, args.input_file, args.platform)
